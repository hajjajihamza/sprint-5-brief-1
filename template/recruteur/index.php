<?php
// Page d'accueil pour les recruteurs
?>
<!DOCTYPE html>
<html lang="fr">
<head>
            ...
            <div class="col-md-8">
                ...
                <div class="card shadow">
                    <div class="card-header bg-warning text-dark">
                        <h3 class="mb-0"><i class="bi bi-person-plus"></i> Espace Recruteur</h3>
                    </div>
                    <div class="card-body text-center">
                        ...
                        <div class="mt-4">
                            <p class="lead">Bienvenue dans votre espace professionnel</p>
                        </div>
